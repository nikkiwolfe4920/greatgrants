...
>(({ className, ...props }, ref) => (
  <SwitchPrimitive.Root
    className={cn(
      ...
      'data-[state=checked]:bg-[var(--brand-600)] data-[state=unchecked]:bg-[var(--gray-200)]',
      className
    )}
    {...props}
    ref={ref}
  >
    <SwitchPrimitive.Thumb
      className={cn(
        'pointer-events-none block h-4 w-4 rounded-full bg-white shadow-[var(--shadow-sm)] transition-transform',
