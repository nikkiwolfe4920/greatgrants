import svgPaths from "./svg-j25yuzbeci";
...
function Container1() {
  return (
    <div className="bg-[rgba(255,255,255,0.2)] h-[35px] relative rounded-[4px] shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start px-[8px] py-[6px] relative size-full">
        <p className="-translate-x-1/2 absolute font-['Cabin:Bold',sans-serif] font-bold leading-[0] left-[23px] text-[0px] text-center text-white top-[6.23px] w-[56px]" style={{ fontVariationSettings: "'wdth' 100" }}>
          <span className="leading-[12.5px] text-[12px]">0 / 8</span>
          <span className="leading-[12.5px] text-[10px]">
            <br aria-hidden="true" />
          </span>
          <span className="leading-[12.5px] text-[12px]">Done</span>
        </p>
      </div>
    </div>
  );
...
export default function WarningTabButton() {
  return (
    <div className="bg-gradient-to-l content-stretch flex flex-col from-[#f59e0b] items-start pt-[16px] px-[12px] relative rounded-bl-[14px] rounded-tl-[14px] shadow-[0px_20px_25px_0px_rgba(0,0,0,0.1),0px_8px_10px_0px_rgba(0,0,0,0.1)] size-full to-[#d97706]" data-name="Warning / Tab Button">
      <Container />
    </div>
  );
}