    ...
    <div className="mb-6 rounded-lg border border-teal-200 bg-teal-50 p-4">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <p className="text-sm font-semibold text-teal-900 mb-1">How completion is measured</p>
          <p className="text-sm text-teal-800 leading-relaxed">
            This section is marked complete once every required question below is answered <strong>Yes</strong>
            {requiresInputs ? <> and every required field has a valid entry</> : null}. As soon as you confirm an
            answer, you'll see a{' '}
            <span className="inline-flex items-center gap-1 align-middle font-semibold text-teal-700">
              <CheckCircle2 className="w-3.5 h-3.5" />
              Confirmed
            </span>{' '}
            badge appear next to that question, so you always know exactly what's done and what's left.
          </p>
        </div>
      </div>
    </div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            ...
            <TabsContent value="financial-info" className="space-y-6">
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <ReadinessScoringBanner requiresInputs />
