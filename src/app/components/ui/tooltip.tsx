  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          // NOTE: intentionally uses explicit gray-900/white rather than the
          // bg-primary/text-primary-foreground tokens — those CSS vars are
          // never registered as Tailwind color utilities in this project
          // (default_shadcn_theme.css, which maps them, isn't imported), so
          // bg-primary/text-primary-foreground silently render as no-ops.
