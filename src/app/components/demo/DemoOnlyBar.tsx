 ...
 *
 * The locked-tour step stepper — prev/next arrows bracketing a step card —
 * used to live centered in this bar. It now docks at the bottom-center of
 * the screen instead (see LockedTourDock), so this bar is just the two
 * flex clusters below: back link + demo message on the left, Login /
 * Create Your Free Account on the right.
 *
 ...
 * here (and LockedTourDock's stepper) are the only ways to move around.
 */
        ...
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="hidden min-w-0 items-center gap-2 text-[#475467] lg:flex">
            ...
            {/* flex-1 + min-w-0 are what let this actually truncate instead
                of overflowing its cluster — a flex item's min-width
                defaults to auto (content size), so without this
